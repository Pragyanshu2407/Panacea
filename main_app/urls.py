...
urlpatterns = [
    ...
    path("admin/reset/maintenance/", hod_views.admin_reset_maintenance, name='admin_reset_maintenance'),
    ...
    path("staff/notes/", staff_views.staff_manage_notes, name="staff_manage_notes"),
    path("staff/tests/", staff_views.staff_manage_tests, name="staff_manage_tests"),
    path("staff/tests/<int:test_id>/toggle/", staff_views.staff_toggle_test_active, name="staff_toggle_test_active"),
    ...
    path("student/notes/", student_views.student_view_notes, name="student_view_notes"),
    path("student/tests/", student_views.student_available_tests, name="student_available_tests"),
    path("student/tests/<int:test_id>/take/", student_views.student_take_test, name="student_take_test"),
